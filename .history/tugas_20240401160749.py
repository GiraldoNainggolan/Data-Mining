...
print("Berdasarkan analisis, saran dapat berupa menyesuaikan harga makanan atau menawarkan promosi pada hari-hari tertentu serta menyesuaikan staf pelayanan berdasarkan kecenderungan pelanggan.")
print()

# 11. Skills/kompetensi yang diperlukan
print("11. Skills/kompetensi yang diperlukan:")
print("Pemahaman statistik deskriptif, penggunaan alat visualisasi data, dan kemampuan interpretasi untuk membuat rekomendasi bisnis.")
